        ...
        for i in range(self.period * 2, len(self.data) - self.max_holding_days):
            ...
            if position is not None:
                ...
                if days_held >= self.max_holding_days:
                    ...
                    if current_profit_pct >= 2.5 and adx_val < self.data.loc[entry_idx, 'ADX'] * 0.85:
                        should_exit = True
                    elif current_profit_pct <= 0 and adx_val < self.data.loc[entry_idx, 'ADX'] * 0.85:
                        should_exit = True
            ...
            if position is None and adx_val > self.adx_threshold:
                ...
                if di_difference >= 40 and volatility <= 0.02:  
